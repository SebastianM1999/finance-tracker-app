...
abstract class KnownAssets {
  ...
  static const List<KnownEtf> etfsAndStocks = [
    ...
    KnownEtf('iShares NASDAQ-100 Acc', 'CNDX', 'ETF', 'LSE'),
    KnownEtf('iShares NASDAQ-100 Acc', 'CSNDX', 'ETF', 'SIX'),
    ...
    KnownEtf('Invesco NASDAQ 100 Acc', 'EQQQ', 'ETF', 'LSE'),
    KnownEtf('Amundi NASDAQ-100 UCITS ETF', 'ANXO', 'ETF', 'Euronext'),
    KnownEtf('L&G NASDAQ 100 UCITS ETF', 'LGNO', 'ETF', 'LSE'),
