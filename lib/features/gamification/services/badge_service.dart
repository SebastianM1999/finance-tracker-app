...
class BadgeService {
  ...
  bool _evaluate(String id, GamificationProfile profile, BadgeContext ctx) {
    switch (id) {
      ...
      // ── Dabei seit: t_xp ──
      case 't_xp_bronze': return profile.totalXP >= 200;
      case 't_xp_silver': return profile.totalXP >= 800;
      case 't_xp_gold':   return profile.totalXP >= 3000;
      case 't_xp_diamond': return profile.totalXP >= 10000;

      // ── Dabei seit: t_level ──
      case 't_level_bronze': return profile.level >= 3;
      case 't_level_silver': return profile.level >= 8;
      case 't_level_gold':   return profile.level >= 20;
      case 't_level_diamond': return profile.level >= 50;
